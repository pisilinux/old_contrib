...
def install():
    ...
    if get.buildTYPE() == "emul32":
        ...
        #for dri in shelltools.ls("%s/usr/lib32/xorg/modules/dri" % get.installDIR()):
            #pisitools.dosym("/usr/lib32/xorg/modules/dri/%s" % dri, "/usr/lib32/dri/%s" % dri)
        return
    
    #for dri in shelltools.ls("%s/usr/lib/xorg/modules/dri" % get.installDIR()):
        #pisitools.dosym("/usr/lib/xorg/modules/dri/%s" % dri, "/usr/lib/dri/%s" % dri)
